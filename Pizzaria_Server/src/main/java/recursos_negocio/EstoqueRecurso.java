 ...
 * @author Jannayna
 */
public class EstoqueRecurso extends ServerResource {
    ...
    public Representation entregarPedido(Representation r) throws IOException, JSONException {
        ...
        ClientResource resource = new ClientResource("http://localhost:80/pizzariaIntermediario/fichaestoque/" + numeroComanda);
    ...
    public Representation cadastrarProduto(Representation r) throws IOException, JSONException {
        ...
        ClientResource resource = new ClientResource("http://localhost:80/pizzariaBasico/produto/cad");
